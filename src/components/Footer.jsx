...
function Footer() {
  return (
    <div
      className="w-fll h-screen p-20 flex gap
    5"
    >
      <div className='w-1/2 h-full font-["Founders Grotesk"] flex flex-col justify-between'>
        <div className="heading">
          <h1 className=" text-[6vw] font-bold uppercase leading-none -mb-15">
            EYE-
          </h1>
          <h1 className=" text-[6vw] font-bold uppercase leading-none -mb-15 ">
            OPENING
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-['Neue Montreal'] mt-10">
          ...
          <a className="block text-small font-medium" href="#">
            Instagram
          </a>
          <a className="block text-small font-medium " href="#">
            Behance
        ...
        <div className="dets font-['Neue Montreal'] mt-10">
          <a className="block text-small font-light" href="#">
            E:
          </a>
          <a className="block text-small font-medium" href="#">
            hello@ochi.design
        ...
        <div className="dets font-['Neue Montreal'] ml-[35vw] mt-[-21vw] ">
          <a className="block text-xl font-light" href="#">
            M:
          </a>
          <a className="block text-small font-medium" href="#">
